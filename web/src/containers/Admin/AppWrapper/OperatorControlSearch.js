	...
	const RAW_SECTIONS = [
		{
			...
			category: ['All', 'Common'],
			description: 'Manage global settings for branding, security, features, onboarding, email, localization, footer, and apps.',
		},
		{
			label: 'Users',
			...
			category: ['All', 'Common'],
			description:'Search, add, and manage users, including profiles, balances, payment methods, orders, and referrals.',
		},
		{
			label: 'Assets',
			...
			description:'Review and manage exchange assets, balances, activity, fees, and limits.',
		},
		{
			label: 'Markets',
			...
			category: ['All', 'Trading'],
			description:'Monitor and manage market activity, including order books, OTC, P2P, and quick trades.',
		},
		{
			label: 'Fiat Controls',
			...
			description:'Configure and monitor fiat deposits, payment accounts, on/off-ramps, and fiat fee settings.',
		},
		{
			label: 'Plugins',
			...
			category: ['All', 'Advanced'],
			description:'Manage exchange plugins, including installed, third-party, and new integrations to explore.',
		},
		{
			label: 'Console',
			content: consoleContent,
			category: ['All', 'Advanced'],
			description:'Edit advanced site layout code for the exchange, including HEAD and BODY sections',
		},
		{
			label: 'Roles',
			...
			description:'Define and manage user roles and their permissions across the exchange.',
		},
		{
			label: 'Sessions',
			content: sessionsContent,
			category: ['All', 'High level'],
			description: 'Monitor active user sessions and review login history for security oversight.',
		},
		{
			label: 'Edit Mode',
			...
			category: ['All', 'Common'],
			description:'Customize the exchange appearance and text, including graphics, themes, and all UI strings',
		},
		{ 
		...
		},
		{
			...
			category: ['All', 'Business'],
			description:'Configure account tiers and their corresponding trading fees.',
		},
		{
			label: 'Stakes',
			...
			category: ['All', 'Business'],
			description:'Configure CeFi staking pools and monitor user stake positions.',
		},
				...
				>
					{subItem?.description ? (
						<Tooltip
							...
							placement="right"
							overlayClassName="custom-description-tooltip"
							visible={activeChildTooltip === `${subItem?.subTitle}-${subItem?.description}`}
							onVisibleChange={(open) => onChildTooltipChange(open, `${subItem?.subTitle}-${subItem?.description}`)}
						>
																	...
																	>
																		{innerItem?.description ? (
																			<Tooltip
																				...
																				placement="right"
																				overlayClassName="custom-description-tooltip"
																				visible={activeChildTooltip === `${innerItem?.innerTitle}-${innerItem?.description}`}
																				onVisibleChange={(open) => onChildTooltipChange(open, `${innerItem?.innerTitle}-${innerItem?.description}`)}
																			>
																				<span className="operator-control-search-content-title pointer">
																					{highlightWithOpacity(
							...
							>
								...
								>
									{categorySections[key]?.map(
										({ label: sectionLabel, content = [], icon, description = '' }, idx) => {
											...
											return (
												...
												title={description}
												placement="top"
												visible={hoveredCard === description && activeChildTooltip === null && !!description}
												>
													<div
													className={
														cardLevelInactive
