...
const roles = {
	'is_admin': [
		...
		'/admin/fees/csv:get',
		'/admin/users/csv:get',
		'/admin/logins/csv:get',
		'/admin/audits/csv:get',
		'/admin/user/balance-history/csv:get',
		'/admin/orders/csv:get',
		'/admin/trades/csv:get',
		'/admin/deposits/csv:get',
		'/admin/withdrawals/csv:get',
		'/admin/user/wallet/csv:get',
		'/admin/user/sessions/csv:get',
		'/admin/balances/csv:get',
		'/admin/stakes/csv:get',
		'/admin/stakers/csv:get',
		'/admin/p2p/dispute/csv:get',
	],
	'is_supervisor': [
		'/admin/exchange:get',
		'/admin/kit:get',
